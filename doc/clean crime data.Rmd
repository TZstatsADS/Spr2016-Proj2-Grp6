...
crime$Lat <- unlist(strsplit(as.character(crime$Location.1), split=c(", ")))[1]
crime$Lat <- unlist(strsplit(crime$Lat, "\\("))[2]
crime$Long <- unlist(strsplit(as.character(crime$Location.1), split=c(", ")))[2]
crime$Long <- unlist(strsplit(crime$Long, "\\)"))[1]
options(digits=8)
